// A-ster.cpp : このファイルには 'main' 関数が含まれています。プログラム実行の開始と終了がそこで行われます。
//
...
// ゲームのマップ情報
int map[MH][MW] = {
	{ N, N, N, N, N, N, N, N, N, B, N, N, N, N, N, N, N, B, N, N },
	{ N, S, B, N, N, N, N, B, N, B, N, N, B, N, N, N, N, B, N, N },
	{ N, N, B, N, N, N, N, B, N, N, N, N, B, N, N, N, N, B, N, N },
	{ B, B, N, B, N, N, B, N, B, N, N, B, N, B, N, N, B, N, B, N },
	{ N, B, N, B, N, B, B, N, B, N, N, N, N, B, N, N, B, N, B, N },
	{ N, N, N, N, N, B, N, N, N, N, N, N, N, N, N, N, N, N, N, N },
	{ N, N, B, N, N, B, N, B, N, N, N, N, B, B, N, N, N, B, N, N },
	{ N, N, B, N, N, B, N, B, N, N, N, N, B, B, N, N, N, B, N, N },
	{ N, B, N, N, N, B, N, N, B, B, B, B, N, B, B, B, B, N, B, N },
	{ N, N, N, N, B, N, N, N, B, N, N, N, N, B, N, N, N, N, N, N },
	{ N, N, N, B, B, N, N, N, B, N, N, N, N, B, N, N, N, N, N, N },
	{ N, N, B, N, N, N, N, B, N, N, N, N, B, B, N, N, N, B, N, N },
	{ N, N, B, N, N, N, N, N, N, N, N, N, N, N, N, N, N, B, N, N },
	{ B, B, N, B, N, B, B, N, B, B, N, B, B, B, B, B, B, B, B, B },
	{ N, N, N, N, B, N, N, N, B, N, B, N, N, N, N, N, N, B, N, N },
	{ N, N, N, N, B, N, N, N, B, N, N, N, N, N, N, N, N, B, N, N },
	{ N, N, B, N, B, N, N, B, N, N, N, N, B, N, N, N, N, B, N, N },
	{ N, N, B, N, N, N, N, N, N, N, N, N, B, N, N, N, N, B, G, N },
	{ N, B, N, B, N, N, B, N, B, N, N, B, N, B, N, N, B, N, B, N },
	{ N, N, N, N, B, B, B, N, B, N, N, N, N, N, N, N, N, N, N, N }
};
...
int main()
{
	...
	for (int i = 0; i < MH; ++i) {
		for (int k = 0; k < MW; ++k) {
			if (S == nodes[i][k].status) printf("ス");
			else if (G == nodes[i][k].status) printf("ゴ");
