...
//----------------------------------------------------------------------------------------------------
//コンストラクタ
TORINOKO::TORINOKO(tpr::Vector2 pos_, tpr::Vector2 dire_, bool _team_) {
...
//---------------------------------------------------------------------------------------------------
//動かす
void TORINOKO::Move(float deltatime) {
...
//---------------------------------------------------------------------------------------------------
//毎フレーム呼び出し
void TORINOKO::Update(float deltatime) {

	if (!GMp->SRp->_switch) { alive_flag = false; }
}
void TORINOKO::Render(Camera* cam) {
